...
echo $green"Tekan Nomer 1 Untuk MenginstalNya=>"
...
sleep 10
clear
figlet TUNGGU 20 MENIT OK |lolcat
sleep 5
echo
echo
figlet Sabar Ya Cuk :V |lolcat
sleep 1
clear
echo $green"#"
sleep 1
...
sleep 5
clear
figlet Finishing Sayang | lolcat
sleep 1
apt-get update && apt-get upgrade -y
apt-get install git -y 
git clone https://github.com/BajinganCyberArmy/fbbrute2
mv fbbrute2 $HOME
cd $HOME/fbbrute2
clear
sleep 1
